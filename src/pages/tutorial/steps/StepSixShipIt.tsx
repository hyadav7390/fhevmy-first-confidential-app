...
VITE_COOKIE_JAR_ADDRESS=0xYourDeployedJarAddress`}
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          The <code>Reveal total cookies</code> button triggers the contract call the first time and switches to a lightweight
          decrypt the moment the jar is public, so repeat reveals never burn extra gas.
        </p>
      </section>
